...
exepath := A_ScriptDir '/browser selector.exe'
MyAppURL := "BrowserSelector"
MyApp := "BrowserSelector"
set(key, data) {
...
set("HKEY_LOCAL_MACHINE\SOFTWARE\" MyApp "\Capabilities\FileAssociations", { %".htm"%: "" MyAppURL "", %".html"%: "" MyAppURL "", %".mhtml"%: "" MyAppURL "", %".shtml"%: "" MyAppURL "", %".xht"%: "" MyAppURL "", %".xhtml"%: "" MyAppURL "",
})
...
set("HKEY_LOCAL_MACHINE\SOFTWARE\RegisteredApplications", { %MyApp%: "Software\" MyApp "\Capabilities",
})
data := {
